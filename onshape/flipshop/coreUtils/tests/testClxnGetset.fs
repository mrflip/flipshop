...
export const MergeCases = [
  ...
  [[{ "a": [1, 2] },              { "a": [3] }],        { "a": [3] },                 'arrays are replaced whole, where lodash would merge them index by index'],
...
export const SetAtCases = [
  ...
  [[{},                          "a.0.b",    1],         { "a": { "0": { "b": 1 } } },    'autovivifies a map even for an integer segment, where lodash would build an array'],
