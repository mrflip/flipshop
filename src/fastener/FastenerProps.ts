...
export const FastenerProps = {
  '1/4': {
    ...
    hhcs:     { driver_sz: 'Wr7/16in', head_diam_af: 11.11, head_ht: 4.14 },
    shcs:     { driver_sz: 'H3/16in',  head_diam_od: 11.11, head_ht: 4.14, key_diam_af: 11.11, key_dp: 11.11 },
    hexnut:   { driver_sz: 'Wr7/16in', diam_af: 11.11,      ht: 5.56,      refsku:       'mcmc_91845A029' },
    sqnut:    { driver_sz: 'Wr1/2in',  diam_af: 11.11,      ht: 4.14,      refsku:       'mcmc_94855A247' },
    // fw_reg:   {},
    // fw_lg:    {},
    // shcs:     {},
    // bhcs:     {},
